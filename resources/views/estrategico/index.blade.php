        ...
        <div class="col-md-10 col-md-offset-1"> 
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    ...
                    <a href="{{route('estrategico.create' )}}" 
                    ...
                    <table class="table  table-striped table-hover">
                        ...
                        <tbody>
                           @foreach ($estrategico as $value)
                            <tr>
                                <td>{{$value->id_estrategico}}</td>
                                <td>{{$value->tx_estrategico}}</td>
                                <td>{{$value->fe_creado}}</td>
                                <td>{{$value->fe_actualizado}}</td>
                                <td> 
                                    <a href="{{route('estrategico.show',$value->id_estrategico)}}"
                                    class="btn btn-sm btn-success">Ver detalle</a>
                                    
                                </td>
                                <td>
                                    <a href="{{route('estrategico.edit',$value->id_estrategico)}}"
                                    class="btn btn-sm btn-default">Editar</a>
                                    
                                </td>
                                 <td> 
                                    {!!Form::open (['route'=>['estrategico.destroy',$value->id_estrategico],
                                    'method'=>'DELETE'])!!}
